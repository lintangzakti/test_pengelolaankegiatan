<div class="container-fluid">
    <div class="alert alert-success" role="alert">
        <i class="fas fa-user-friends"></i> Form Update Data Informasi Sekolah
    </div>

	<?php foreach($informasi as $info): ?>
	<form method="post" action="<?php echo base_url('administrator/c_informasi/update_informasi_aksi'); ?>">

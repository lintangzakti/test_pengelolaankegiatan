...
<head>
  ...
  <title>Login Sistem Informasi Pengelolaan Kegiatan Sekolah Al-Bahri</title>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
					<img src="<?php echo base_url();?>assets/logo/logo-sekolah.png" alt="gambar-logo" height="150px" width="150px"><br><br>
                  ...
                  <form method="post" action="<?php echo base_url('administrator/auth/proses_login')?>" class="user">
                    ...
                    <button class="btn btn-primary btn-user btn-block">Login sekarang</button>
                  </form>
                </div>
              </div>
            </div>

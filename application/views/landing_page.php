...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav mr-auto p-2">
      <a class="nav-item nav-link active ml-3" href="<?php echo base_url('landing_page') ?>">Beranda <span class="sr-only">(current)</span></a>
	...
	<form class="form-inline">
		...
		<button class="btn btn-outline-primary my-2 my-sm-0 ml-2" type="submit"><a href="<?php echo base_url('administrator/auth') ?>">Login</a></button>
	</form>
  </div>
</nav>
  ...
  <div class="card-body">
    <p class="card-text">
		<?php foreach($tentang as $ttg) : ?>
			<?php echo word_limiter($ttg->sejarah,20) ?>
		<?php endforeach; ?>
	</p>
